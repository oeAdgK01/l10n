...
Οι δημιουργοι ευρετηρίων (Indexers) θα μπορούν να συμμετάσχουν στο The Graph κλειδώνοντας το GRT και εκτελώντας μια έκδοση του Κόμβου Graph.
...
Οι επιμελητές και οι εκπρόσωποι θα επιμεληθούν και θα εκπροσωπούν μέσω του Graph Explorer. Στην τελική έκδοση του δικτύου, ο Graph Explorer θα είναι μια πλήρως αποκεντρωμένη εφαρμογή και για τη χρήση του απαιτείται ένα πρόγραμμα περιήγησης με δυνατότητα εκτέλεσης αποκεντρομένων εφαρμογών (dApp) και πορτοφόλι Ethereum.
