...
_Για τους προγραμματιστές, τα API για τη δημιουργία ενός υπογράφου θα παραμείνουν σε μεγάλο βαθμό τα ίδια καθως χρησιμοποιούν έναν τοπικό ή φιλοξενούμενο Κόμβο Graph._
...
Αυτή η εφεδρεία σημαίνει ότι ακόμη και αν ένας μεμονωμένος δημιουργος ευρετηρίου είναι εκτός σύνδεσης, οσο υπάρχει ζήτηση για ερωτήματα σε ένα σύνολο δεδομένων, άλλοι δημιουργοί ευρετηρίων θα έχουν κίνητρα για να απορροφήσουν την επιπλέον εργασία.

Οι συναλλαγές στην αγορά ερωτημάτων τιμολογούνται με βάση το εύρος ζώνης και την υπολογιστική ισχής που είναι απαραίτητη για την επεξεργασία του ερωτήματος.

Ας ρίξουμε μια ματιά σε μια τυπική ροή για έναν καταναλωτή που αλληλεπιδρά με την αγορά ερωτημάτων.

- **Εύρεση Υπηρεσίας**. Ο καταναλωτής ρωτάει το The Graph ποιοί δημιουργγοί ευρετηρίων έχουν τα δεδομένα που τους ενδιαφέρουν.
ανακάλυψη υπηρεσίας
...
Για την υποστήρικη της λειτουργία αγοράς ερωτημάτων, το πρωτόκολλο εισάγει ένα εγγενές token: Graph Tokens (GRT).
