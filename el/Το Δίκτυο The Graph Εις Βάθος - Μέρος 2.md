...
Η χρήση κλειδωμάτων με κανάλια πληρωμών δεν είναι καινούργια. Τόσο οι έρευνες που έχουν διεξαχθεί στο Lightning όσο και στο Raiden αναφέρουν την χρήση αντανακλώμενου κρυπτογραφήματος (hash preimage) για το ξεκλείδωμα μιας μικροπληρωμής. Αυτό είναι ιδιαίτερα χρήσιμο για μικροπληρωμές πολλαπλών hop όπου κάθε hop (αναπήδηση) είναι κλειδωμένο με το ίδιο κρυπτογράφημα και μπορεί να ξεκλειδωθεί από ένα δεδομένο, την αντανάκλαση (preimage), που παράγει αυτό το κρυπτογράφημα όταν εισάγεται σε μια καθορισμένη συνάρτηση κρυπτογράφημα.
